...
public partial class OshinokoNEnergyCounter : NEnergyCounter
{
	...
	private void EnsureHighlightOverlay()
	{
		...
		var addMat = ResourceLoader.Load<Material>("res://Oshinoko/themes/canvas_item_material_additive_shared.tres");
		if (addMat != null)
		{
